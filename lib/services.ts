...
サービスURL: https://keiba-yoso-ai.vercel.app

以下のいずれかのテーマで、140文字以内の日本語ツイートを作成:
1. 今週末の重賞レースへの言及と「AIが予想」という訴求
2. AI予想の精度・実績への言及（「的中続出」など）
3. 競馬ファンへのTips（複勝・三連複など馬券の考え方）
4. 「無料で試せる」という訴求

末尾に改行して #競馬予想 #G1予想 #AI競馬 を付ける。
URLは含めずテキストのみ返す。改行は\\nで表現。`,
  },
  {
    id: "claim",
...
以下のいずれかのテーマで、140文字以内の日本語ツイートを作成（男子向けカジュアルトーンで）:
